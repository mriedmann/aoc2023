...
fn main() -> Result<(),Error> {
    ...
    match level {
        1 => { result_a = level01::LevelSolver::solve_a(&input_file_a.to_string())?; result_b = level01::LevelSolver::solve_b(&input_file_b.to_string())?; },
        2 => { result_a = level02::LevelSolver::solve_a(&input_file_a.to_string())?; result_b = level02::LevelSolver::solve_b(&input_file_b.to_string())?; },
        3 => { result_a = level03::LevelSolver::solve_a(&input_file_a.to_string())?; result_b = level03::LevelSolver::solve_b(&input_file_b.to_string())?; },
